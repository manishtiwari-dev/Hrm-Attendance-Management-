            ...
            <div class="card contact-content-body">
                <form action="{{ url('hrm/leave/update/' . $data_list->id) }}" id="userForm" method="POST"
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between py-2 px-3">
                        <h6 class="tx-15 mg-b-0">{{ __('hrm.edit_leave') }}</h6>
                        ...
                        <div data-label="Example" class="df-example demo-forms">
                            <div class="form-row">
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <input name="leave_date" value="{{ $data_list->leave_date }}" id="from_date"
                                        type=""
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <textarea name="reason" rows="2" value="" class="form-control" required>{{ $data_list->reason }}</textarea>
                                    <div class="invalid-feedback">
                                        {{ __('hrm.reason_error') }}
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control selectsearch @error('id') is-invalid @enderror "
                                            ...
                                            @if (!empty($user_list))
                                                @foreach ($user_list as $user)
                                                    <option
                                                        value="@if (!empty($data_list)) {{ $data_list->user_id }} @endif"
                                                        {{ $user->id == $data_list->user_id ? 'selected' : '' }}>
